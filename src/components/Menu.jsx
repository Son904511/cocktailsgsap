...
const Menu = () => {
  ...
  const goToSlide = (index) => {
    const newIndex = (index + totalCocktails) % totalCocktails; //cyclic process of getting index || 0->1->2->3 then wouldnot have any more cocktails and ehen user click four itgoes to 4 or 5 dont have many
